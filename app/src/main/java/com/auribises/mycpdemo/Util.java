...
/**
 * Created by Tajinderpal Singh on 11/04/17.
 */
...
public class Util {
    ...
    // URL
    public static final String INSERT_STUDENT_PHP = "http://tajinderj.esy.es/enc2017/insert.php";

    public static final String RETRIEVE_STUDENT_PHP = "http://tajinderj.esy.es/enc2017/retrieve.php";

    public static final String DELETE_STUDENT_PHP = "http://tajinderj.esy.es/enc2017/delete.php";

    public static final String UPDATE_STUDENT_PHP = "http://tajinderj.esy.es/enc2017/update.php";
}
